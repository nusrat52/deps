             ...
             <div className="row">
               <div className="col-12 col-lg-6 pb-4 pb-lg-0">
                 ...
                 <div className="contact-us__address">
                   <p> {adress.address} <br />Email: {adress.email_address} <br />{postQuestions['number'][router.locale]}: {adress.number1} </p>
                   <p>
                      ...
                      <form onSubmit={submitEvent}>
                       <div className="form-row">
                         <div className="form-group col-md-6">
                           ...
                           <input name='name' value={name} onChange={(e)=>setName(e.target.value)} required type="text" id="form-name" className="form-control" placeholder={postQuestions['name'][router.locale]} />
                         </div>
                         <div className="form-group col-md-6">
                           <label htmlFor="form-email">{postQuestions['email'][router.locale]}</label>
                           <input name='email' value={email} onChange={(e)=>setEmail(e.target.value)} required type="email" id="form-email" className="form-control" placeholder={postQuestions['email'][router.locale]} />
                         </div>
                       </div>
